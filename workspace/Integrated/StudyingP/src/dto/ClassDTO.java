...
public class ClassDTO {
	...
	public Date getCls_period() {
		return cls_period;
	}
	public void setCls_period(Date cls_period) {
		this.cls_period = cls_period;
	}

	public int getCls_delete() {
		return cls_delete;
	}
	public void setCls_delete(int cls_delete) {
		this.cls_delete = cls_delete;
	}
	@Override
	public String toString() {
		return "ClassDTO [cls_code=" + cls_code + ", cls_category=" + cls_category + ", cls_name=" + cls_name
				...
				+ cls_period + ", cls_delete=" + cls_delete + "]";
	} 
